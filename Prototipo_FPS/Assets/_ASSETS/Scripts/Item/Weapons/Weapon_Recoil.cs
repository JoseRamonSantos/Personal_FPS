...
public class Weapon_Recoil : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (!RecoilPositionTranform)
        {
            RecoilPositionTranform = transform.Find("Armature/weapon/ShootSpot");
        }
        if (!RecoilRotationTranform)
        {
            RecoilRotationTranform = transform.Find("Armature/weapon/ShootSpot");
        }
    }
