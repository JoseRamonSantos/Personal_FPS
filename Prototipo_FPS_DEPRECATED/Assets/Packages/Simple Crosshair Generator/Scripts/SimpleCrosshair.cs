...
{
    [Range(0, 500), Tooltip("Controls the length of each crosshair line.")]
    public int size = 10;

    [Range(0, 500), Tooltip("Controls the width of each crosshair line.")]
    public int thickness = 2;

    [Range(0, 500), Tooltip("Controls the distance between the center of the crosshair and the start of each crosshair line.")]
    public int gap = 5;
...
public class SimpleCrosshair : MonoBehaviour
{
    ...
    public void InitialiseCrosshairImage()
    {
        ...
        CanvasScaler cmpCanvasScaler = crosshairGameObject.AddComponent<CanvasScaler>();
        
        cmpCanvasScaler.uiScaleMode = CanvasScaler.ScaleMode.ConstantPixelSize;
        
        
        
        /*cmpCanvasScaler.uiScaleMode = CanvasScaler.ScaleMode.ScaleWithScreenSize;
        cmpCanvasScaler.referenceResolution = new Vector2(720, 720);
        cmpCanvasScaler.screenMatchMode = CanvasScaler.ScreenMatchMode.Expand;
        cmpCanvasScaler.referencePixelsPerUnit = 100;
        */
